              ...
              <div class="form-row">
               ...
               <div class="form-row">
                <div class="form-group col-sm-12">
                  ...
                  <button class="btn btn-info" type="button" onclick="javasript:openTeamWindow();">팀원 변경</button>
                </div>
              </div>
...
<script src="./jquery-ui-1.12.1/datepicker-ko.js"></script>
    ...
    function openLeaderWindow(){
    	var settings='toolbar=0, directories=0,status=no,menubar=0,scrollbars=auto,resizable=no,height=200,width=600,right=0,top=0';
